...
def docs_live_lang(session: nox.Session) -> None:
    """
...
def clean_dir(session: nox.Session) -> None:
...
def update_translations(session: nox.Session) -> None:
    """
...
def build_languages(session: nox.Session) -> None:
    """
...
def build_translations(session: nox.Session) -> None:
    """
...
def build_translations_test(session: nox.Session) -> None:
    """
